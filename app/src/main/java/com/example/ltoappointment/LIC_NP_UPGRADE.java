...
import com.example.ltoappointment.databinding.ActivityLicNpUpgradeBinding;
...
public class LIC_NP_UPGRADE extends AppCompatActivity implements View.OnClickListener {
    ...
    ActivityLicNpUpgradeBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLicNpUpgradeBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        next = findViewById(R.id.nextBTN);
        back = findViewById(R.id.backBTN);
        drawerLayout = findViewById(R.id.np_upgrade_drawer);
    ...
    public void ClickLogout(View view){
        fAuth.signOut();
        startActivity(new Intent(LIC_NP_UPGRADE.this, MainActivity.class));
        finish();
    }
    ...
    public void download(){
        ...
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                ...
                downloadFiles(LIC_NP_UPGRADE.this, "APLFORM", ".pdf", DIRECTORY_DOWNLOADS, url);
            }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(LIC_NP_UPGRADE.this, "upload requirement1 failed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(LIC_NP_UPGRADE.this, "upload requirement2 failed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.uf1) {
            ...
            if(imageUri1 == null || imageUri2 == null || imageUri3 == null){
                ...
                UploadRequirements();
                startActivity(new Intent(LIC_NP_UPGRADE.this, Calendar.class));
            }
        } else if (v.getId() == R.id.backBTN) {
            startActivity(new Intent(LIC_NP_UPGRADE.this, Homepage.class));
        }
    }
