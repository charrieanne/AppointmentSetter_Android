...
public class LIC_SP_NEW extends AppCompatActivity implements View.OnClickListener {

    public Uri imageUri1, imageUri2, imageUri3, imageUri4, imageUri5, imageUri6;
    FirebaseStorage storageFile;
    StorageReference storageReference;
    ActivityResultLauncher<String> uf_1, uf_2, uf_3, uf_4, uf_5, uf_6;
    ActivityLicSpNewBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLicSpNewBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        next = findViewById(R.id.nextBTN);
        back = findViewById(R.id.backBTN);
        drawerLayout = findViewById(R.id.sp_new_drawer);
        ...
        uf_5 = registerForActivityResult(
                new ActivityResultContracts.GetContent(),
                new ActivityResultCallback<Uri>() {
                    @Override
                    public void onActivityResult(Uri result) {
                        if(result != null){
                            binding.uf5.setText(result.getPath());
                            imageUri5 = result;
                        }
                    }
                }
        );
        uf_6 = registerForActivityResult(
                new ActivityResultContracts.GetContent(),
                new ActivityResultCallback<Uri>() {
                    @Override
                    public void onActivityResult(Uri result) {
                        if(result != null){
                            binding.uf6.setText(result.getPath());
                            imageUri6 = result;
                        }
                    }
                }
        ...
        binding.uf6.setOnClickListener(this);
        binding.uf7.setOnClickListener(this);
    }
    ...
    public void ClickLogout(View view){
        fAuth.signOut();
        startActivity(new Intent(LIC_SP_NEW.this, MainActivity.class));
        finish();
    }
    ...
    public void download(){
        ...
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                ...
                downloadFiles(LIC_SP_NEW.this, "APLFORM", ".pdf", DIRECTORY_DOWNLOADS, url);
            }
    ...
    private void UploadRequirements(){
        ...
        StorageReference reference5= storageFile.getReference().child("requirements/" + userID + "/" + UUID.randomUUID());
        StorageReference reference6= storageFile.getReference().child("requirements/" + userID + "/" + UUID.randomUUID());
                    ...
                    .addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(LIC_SP_NEW.this, "upload requirement 1 failed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(LIC_SP_NEW.this, "upload requirement 2 failed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(LIC_SP_NEW.this, "upload requirement 3 failed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
            ...
            reference4.putFile(imageUri4)
                    .addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            if(task.isSuccessful()){
                                // Toast.makeText(LIC_NP_RENEW.this, "upload successful", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(LIC_SP_NEW.this, Calendar.class));
                            }
                            else{
                                Toast.makeText(LIC_SP_NEW.this, "upload requirement 4 failed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(LIC_SP_NEW.this, "upload requirement 5 failed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
        else{
            Toast.makeText(this, "upload requirement 6 first", Toast.LENGTH_SHORT).show();
        }


        if (imageUri6 != null ){
            reference6.putFile(imageUri6)
                    .addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(LIC_SP_NEW.this, "upload requirement 6 failed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.uf1) {
            ...
            startActivity(new Intent(LIC_SP_NEW.this, Homepage.class));
        }
    }
}