...
import com.example.ltoappointment.databinding.ActivityClRenewBinding;
...
public class CL_RENEW extends AppCompatActivity implements View.OnClickListener{
    ...
    ActivityClRenewBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityClRenewBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        next = findViewById(R.id.nextBTN);
        back = findViewById(R.id.backBTN);
        drawerLayout = findViewById(R.id.cl_renew_drawer);
    ...
    public void ClickLogout(View view){
        fAuth.signOut();
        startActivity(new Intent(CL_RENEW.this, MainActivity.class));
        finish();
    }
    ...
    public void download(){
        ...
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                ...
                downloadFiles(CL_RENEW.this, "APLFORM", ".pdf", DIRECTORY_DOWNLOADS, url);
            }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(CL_RENEW.this, "upload requirement 1 failed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(CL_RENEW.this, "upload requirement 2 failed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(CL_RENEW.this, "upload requirement 3 failed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(CL_RENEW.this, "upload requirement 4 failed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.uf1) {
            ...
            if(imageUri1 == null || imageUri2 == null || imageUri3 == null || imageUri4 == null){
                ...
                UploadRequirements();
                startActivity(new Intent(CL_RENEW.this, Calendar.class));
            }
        } else if (v.getId() == R.id.backBTN) {
            startActivity(new Intent(CL_RENEW.this, Homepage.class));
        }
    }
}