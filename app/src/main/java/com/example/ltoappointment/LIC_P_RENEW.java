...
import com.example.ltoappointment.databinding.ActivityLicPrenewBinding;
...
public class LIC_P_RENEW extends AppCompatActivity implements View.OnClickListener {

    public Uri imageUri1, imageUri2, imageUri3;
    FirebaseStorage storageFile;
    StorageReference storageReference;
    private ActivityLicPrenewBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLicPrenewBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        next = findViewById(R.id.nextBTN);
        back = findViewById(R.id.backBTN);
        drawerLayout = findViewById(R.id.p_renew_drawer);
    ...
    public void ClickLogout(View view){
        fAuth.signOut();
        startActivity(new Intent(LIC_P_RENEW.this, MainActivity.class));
        finish();
    }
    ...
    public void download(){
        ...
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                ...
                downloadFiles(LIC_P_RENEW.this, "APLFORM", ".pdf", DIRECTORY_DOWNLOADS, url);
            }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(LIC_P_RENEW.this, "upload requirement 1 successful", Toast.LENGTH_SHORT).show();
                            }
                            else{
                                Toast.makeText(LIC_P_RENEW.this, "upload requirement 1 failed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
        ...
        if (imageUri2 != null ){
            reference2.putFile(imageUri2)
                    .addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(LIC_P_RENEW.this, "upload requirement 2 successful", Toast.LENGTH_SHORT).show();
                            }
                            else{
                                Toast.makeText(LIC_P_RENEW.this, "upload requirement 2 failed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
        ...
        if (imageUri3 != null ){
            reference3.putFile(imageUri3)
                    .addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(LIC_P_RENEW.this, "upload requirement 3 successful", Toast.LENGTH_SHORT).show();
                            }
                            else{
                                Toast.makeText(LIC_P_RENEW.this, "upload requirement 3 failed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.uf1) {
            ...
            if(imageUri1 == null || imageUri2 == null || imageUri3 == null){
                ...
                UploadRequirements();
                startActivity(new Intent(LIC_P_RENEW.this, Calendar.class));
            }
        } else if (v.getId() == R.id.backBTN) {
            startActivity(new Intent(LIC_P_RENEW.this, Homepage.class));
        }
    }
}